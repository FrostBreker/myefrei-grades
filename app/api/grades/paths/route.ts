...
export async function GET() {
    return instrumentApiRoute('grades/paths/GET', async () => {
        try {
            ...
            if (error instanceof Error) noticeError(error, { route: 'grades/paths/GET' });
            return NextResponse.json(
...
export async function POST(request: Request) {
    return instrumentApiRoute('grades/paths/POST', async () => {
        try {
            const session = await requestAuthCheck();
            if (!session || !session?.user) return;
            ...
            if (error instanceof Error) noticeError(error, { route: 'grades/paths/POST' });
            return NextResponse.json(
                {error: "Erreur serveur"},
                {status: 500}
            );
...
export async function PUT(request: Request) {
    return instrumentApiRoute('grades/paths/PUT', async () => {
        try {
            const session = await requestAuthCheck();
            if (!session || !session?.user) return;
            ...
            if (error instanceof Error) noticeError(error, { route: 'grades/paths/PUT' });
            return NextResponse.json(
                {error: "Erreur serveur"},
                {status: 500}
            );
...
export async function DELETE(request: Request) {
    return instrumentApiRoute('grades/paths/DELETE', async () => {
        try {
            const session = await requestAuthCheck();
            if (!session || !session?.user) return;
            ...
            if (error instanceof Error) noticeError(error, { route: 'grades/paths/DELETE' });
            return NextResponse.json(
                {error: "Erreur serveur"},
                {status: 500}
            );
