...
import { Plus, Trash2, Shield, Loader2, X, ArrowLeft, Save, AlertCircle } from "lucide-react";
import { UE, Module as ModuleType, GradeEntry, GradeType, SemesterData } from "@lib/grades/types";
...
export default function CreateYearTemplatePage() {
    ...
    const updateUES2 = (index: number, field: keyof UE, value: any) => {
        const updated = [...uesS2];
        updated[index] = { ...updated[index], [field]: value };
        setUesS2(updated);
    };
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    const updateModule = (semesterNum: 1 | 2, ueIndex: number, moduleIndex: number, field: keyof ModuleType, value: any) => {
        if (semesterNum === 1) {
            const updated = [...uesS1];
    ...
    const handleCreateTemplate = async () => {
        ...
        if (!cursus || !filiere || !groupe || !academicYear) {
            alert("Veuillez remplir tous les champs généraux");
            return;
        }
        ...
        try {
            ...
            if (response.ok && data.success) {
                alert("✅ Template d'année créé avec succès !");
                                                                                    ...
                                                                                    {mod.grades.map((grade, gradeIndex) => (
                                                                                        <div key={gradeIndex} className="grid grid-cols-5 gap-2 p-3 bg-background rounded border">
                                                                                            <div>
                                                                                                <Select
                                                                                                    value={grade.type}
                                                                                                    onValueChange={(val) => updateGrade(semesterNum, ueIndex, modIndex, gradeIndex, "type", val)}
                                                                                                >
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-4xl font-bold">Créer un Template d&apos;Année</h1>
                                <p className="text-muted-foreground">
                                    Définissez S1 et/ou S2 pour une année complète
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="space-y-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    ...
                                    <Select value={cursus} onValueChange={setCursus}>
                                        ...
                                        <SelectContent>
                                            <SelectItem value="PGE">PGE</SelectItem>
                                ...
                                <div className="space-y-2">
                                    <Label>Filière *</Label>
                                    <Input
                                        placeholder="P1, L3, M1, INGENIEUR..."
                                        value={filiere}
                    ...
                    <div className="flex justify-between gap-4 sticky bottom-0 bg-background py-4 border-t">
                        ...
                        <Button
                            ...
                            disabled={submitting || !cursus || !filiere || !groupe || !academicYear || (!defineS1 && !defineS2)}
                        >
                            {submitting ? (
                                <>
