...
import { GraduationCap, Plus, BookOpen, Loader2, Edit, RefreshCw, AlertTriangle } from "lucide-react";
import {
    AlertDialog,
    AlertDialogAction,
    AlertDialogCancel,
...
export default function GradesPageV2({ initialProfile, initialSemesters, userEmail }: GradesPageProps) {
    ...
    useEffect(() => {
        if (dialogOpen || changePathDialogOpen) {
            loadAvailableTemplates();
        }
    }, [dialogOpen, changePathDialogOpen]);
